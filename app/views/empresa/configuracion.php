<!-- app/views/empresa/configuracion.php -->
<h2>Configuración de la Empresa</h2>
<p>Aquí puedes ver o editar los datos generales de la empresa.</p>

<form action="<?= $form_action ?>" method="POST" class="formulario" novalidate>
    ...
    <div class="contenedor-botones">
        <?php if ($modo === 'ver'): ?>
            <a href="/empresa/configuracion?edit=1" class="boton boton-editar">Modificar</a>
        <?php else: ?>
            <a href="/empresa/configuracion" class="boton boton-cancelar">Cancelar</a>
